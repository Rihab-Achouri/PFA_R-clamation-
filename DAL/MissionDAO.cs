...
namespace DAL
{
    public class MissionDAO
    {
        ...
        {
            string requete = String.Format("update Mission set Etat='{0}', Departement='{1}'," +
                " Debut_traitement='{2}', Date_cloture='{3}', Description='{4}' where Num={5};", Etat, Département, Début_traitement, Date_cloture, Description, Num);
            return utils.miseajour(requete);
        }
